...
uint8_t some_data[] = "We are testing I2C mastetr Tx\n";
...
void GPIO_ButtonInit(void)
{
    ...
    GPIOBtn.GPIO_PinConfig.GPIO_PinPulPdControl = GPIO_NO_PUPD;
    GPIO_Init(&GPIOBtn);
...
int main(void)
{
    ...
    while(1)
    {
        ...
        while(!GPIO_ReadFromInputPin(GPIOB, GPIO_PIN_NO_14));
